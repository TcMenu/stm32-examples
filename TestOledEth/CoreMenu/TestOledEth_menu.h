...
#define MENU_DATE_ID  6
#define MENU_TIME_NOW_ID  7
#define MENU_COUNT_ID  4
#define MENU_ADD_ID  5
#define MENU_EXTRAS_ID  8
#define MENU_FOODS_ID  9
#define MENU_LARGE_ID  10
#define MENU_RGB_ID  11
#define MENU_FLOAT_ID  12
#define MENU_COUNT_LIST_ID  13
...
inline ScrollChoiceMenuItem& getMenuFoods() { return getScrollChoiceItemById(MENU_FOODS_ID); }
inline EditableLargeNumberMenuItem& getMenuLarge() { return getLargeNumberItemById(MENU_LARGE_ID); }
inline Rgb32MenuItem& getMenuRGB() { return getRgb32ItemById(MENU_RGB_ID); }
inline FloatMenuItem& getMenuFloat() { return getFloatItemById(MENU_FLOAT_ID); }
inline ListRuntimeMenuItem& getMenuCountList() { return getListItemById(MENU_COUNT_LIST_ID); }


// Provide a wrapper to get hold of the root menu item and export setupMenu
inline MenuItem& rootMenuItem() { return getMenuDate(); }
void setupMenu();

// Callback functions must always include CALLBACK_FUNCTION after the return type
#define CALLBACK_FUNCTION

int fnCountListRtCall(RuntimeMenuItem* item, uint8_t row, RenderFnMode mode, char* buffer, int bufferSize);
