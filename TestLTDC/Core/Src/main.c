...
#include <stdlib.h>
#include "../../CoreMenu/frameBufferSetup.h"
#include "../../CoreMenu/appMain.h"
...
int main(void)
{
  ...
  /* Start the free-running microsecond counter as early as possible. */
  MX_TIM2_Init();
...
/**
  ...
  * @note TIM2 is a free-running 32-bit, 1 MHz counter for micros().
  */
static void MX_TIM2_Init(void)
{
  ...
  if (HAL_TIM_ConfigClockSource(&htim2, &clockSource) != HAL_OK)
  {
    Error_Handler();
  }
